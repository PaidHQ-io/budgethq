...
export const StatRow=({label,value,color,T,size=12})=>(<div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"4px 0"}}><span style={{fontSize:size,color:T.textSub}}>{label}</span><span style={{fontSize:size,fontFamily:"Inter,sans-serif",fontWeight:600,color:color||T.text}}>{value}</span></div>);
